...
public class WriteObject implements SequenceLengthCalculator{
    ...
    public  int calculate(double alpha) {
        ...
        double square = Math.pow(10 * cos_alpha, 2); // вычисляем квадрат
        double cube = Math.pow(10 * cos_alpha, 3); // вычисляем куб
